window.odkCommonDefinitions = {
  "_tokens": {
    ...
    "hh_id_placeholder": {
      "string_token": "hh_id_placeholder",
      "text": {
        "default": "ABC-123",
        "pt": "ABC-123",
        "sw": "ABC-123"
    ...
    "roster_confirm_painted": {
      ...
      "text": {
        "default": "Confirm with the person in the household:",
    ...
    "roster_confirm_1": {
      ...
      "text": {
        "default": "1) This list of members corresponds to the household you are in.",
        "pt": "1) Esta lista de membros corresponde à família em que você está.",
        "sw": "1) Hii orodha ya washiriki inaendana na kaya uliyopo."
      },
      "_row_num": 28
    },
    "roster_confirm_2": {
      ...
      "text": {
        "default": "2) The painted ID matches the household ID in the screen.",
        "pt": "2) O ID pintado corresponde ao ID da família na tela.",
        "sw": "2) Namba iliyochorwa inaendana na namba ya kaya inayoonekana kwenye kifaa chako"
      },
      "_row_num": 29
    },
    "roster_confirm_hint": {
      ...
      "text": {
        "default": "There could have been some changes in the list of household members, but at least one person should be correct.",
