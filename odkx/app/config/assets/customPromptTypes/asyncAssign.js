'use strict';
define([
    './customErrorMsg', 'jquery','underscore', 'opendatakit', 'database', 'prompts'
],
function(customErrMsg, $,       _, opendatakit, database) {
...
var async_assign = customErrMsg.base.extend({
    type: "async_assign",
    debug: false,
    valid: true,
    templatePath: '../config/assets/customPromptTypes/templates/async_assign.handlebars',
