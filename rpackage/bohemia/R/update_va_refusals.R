#' Update va refusals data in the bohemia database
#' 
#' Take the formatted va refusals data (as generated by "format_va_refusals") and update the data in the database
#' @param formatted_data A list of dataframes (just one actually) as generated by format_va_refusals
...
update_va_refusals <- function(formatted_data,
                              con = NULL,
                              host = NULL,
                              user = NULL,
                              pass = NULL,
