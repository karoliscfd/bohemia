...
out$hamlet_xdf %>% write_csv('~/Desktop/tza_hamlets.csv')
out$cluster_xdf %>% write_csv('~/Desktop/tza_clusters.csv')
...
```{r}
# Hamlet level
mean(out$hamlet_xdf$n_cattle)
median(out$hamlet_xdf$n_cattle)
quantile(out$hamlet_xdf$n_cattle, c(0.25, 0.75))
range(out$hamlet_xdf$n_cattle)

# Cluster level
mean(out$cluster_xdf$n_cattle)
median(out$cluster_xdf$n_cattle)
quantile(out$cluster_xdf$n_cattle, c(0.25, 0.75))
range(out$cluster_xdf$n_cattle)
```
...
```{r}
out$hamlet_xdf %>% write_csv('~/Desktop/moz_hamlets.csv')
out$cluster_xdf %>% write_csv('~/Desktop/moz_clusters.csv')
```


```{r}
# Hamlet level
mean(out$hamlet_xdf$n_pigs)
median(out$hamlet_xdf$n_pigs)
quantile(out$hamlet_xdf$n_pigs, c(0.25, 0.75))
range(out$hamlet_xdf$n_pigs)

# Cluster level
mean(out$cluster_xdf$n_pigs)
median(out$cluster_xdf$n_pigs)
quantile(out$cluster_xdf$n_pigs, c(0.25, 0.75))
range(out$cluster_xdf$n_pigs)
```
