...
cods <- 
  tibble(user_id = c(1,2,1,2,3,4,5,3),
         ...
         cod_code_1 = c('G03', 'P23', 'G03', 'A06', 'A09', 'A15', 'A20', 'A20'),
         cod_1 = c('Meningitis', 'Pneumonia', 'Meningitis','Dysentery Acute/Chronic', 'Diarrhoea','TB Confirmed', 'Plague','Plague'),
         ...
         cod_code_3 = c('T67', 'G03', 'A06', 'A09', 'A15', 'A20', 'A20', 'P23'),
         cod_3 = c('Effects of heat and light', 'Meningitis','Dysentery Acute/Chronic', 'Diarrhoea','TB Confirmed', 'Plague','Plague', 'Pneumonia'),
